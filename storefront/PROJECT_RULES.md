...
├── layout/
│   └── templates/
│       ├── headers/          ← Header variants (Header01.tsx, Header08.tsx, etc.)
│       └── footers/          ← Footer variants (Footer01.tsx, Footer10.tsx, etc.)
├── home/
...
### ❌ Don't Mix Tailwind and Bootstrap
```tsx
// ❌ WRONG
...
### ❌ Don't Use Hardcoded Paths for Furnitor Assets
```tsx
// ❌ WRONG
...
### ❌ Don't Break Medusa Functionality
...
**Remember:**
1. ✅ Bootstrap 4 only - NO Tailwind
2. ✅ Furnitor assets in `/furnitor/` directory
3. ✅ Keep all `data-*` attributes
4. ✅ Use Next.js Link and Image components
5. ✅ Preserve Medusa.js functionality
6. ✅ Follow Furnitor design patterns
7. ✅ Test responsive design
8. ✅ Initialize JavaScript plugins
