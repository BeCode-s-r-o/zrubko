          ...
          {banners.map((banner, index) => (
            <div key={index} className={banner.className || (index === 0 ? 'col-lg-8 mb-6 mb-lg-0' : 'col-lg-4')}>
              <div className="card border-0 banner banner-07">
                ...
                ></div>
                <div className={`card-img-overlay d-inline-flex flex-column ${index === 0 ? 'p-4 px-sm-7 py-sm-8' : 'align-items-center p-4 p-sm-7'}`}>
                  <h3 className={`card-title ${index === 0 ? 'fs-30 fs-md-40' : 'fs-30 fs-md-34 mb-2'}`}>
                    {banner.title}
