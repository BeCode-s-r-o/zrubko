    ...
    <div className="py-8 border-b border-gold/10">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 px-4">
        ...
        <div>
          ...
          <div className="space-y-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                <a href="mailto:info@zrubko.sk" className="text-ebony hover:text-gold font-medium transition-colors">
                  info@zrubko.sk
                </a>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <a href="tel:+421900000000" className="text-ebony hover:text-gold font-medium transition-colors">
                  +421 900 000 000
                </a>
        ...
        <div>
          ...
          <div className="h-64 bg-gradient-to-br from-gold/10 to-champagne/10 rounded-lg border border-gold/20 overflow-hidden relative group">
            <iframe
