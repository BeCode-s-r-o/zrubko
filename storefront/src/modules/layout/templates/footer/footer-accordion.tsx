  ...
  return (
    <div className="border-b border-accent-light/20 md:border-none">
      ...
      <div className="hidden md:block mb-6">
        ...
        <div className="w-8 h-0.5 bg-gradient-to-r from-accent to-accent-light"></div>
      </div>
      
      {/* Mobile Accordion Button */}
      <button
        onClick={() => setIsOpen(!isOpen)}
        className="flex justify-between items-center py-4 w-full md:hidden bg-accent-light/5 hover:bg-accent-light/10 rounded-lg px-4 transition-all duration-200"
      >
